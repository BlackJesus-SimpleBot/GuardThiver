...
@ScriptManifest(author = "BlackJesus", category = Category.THIEVING, description = "Thives guard's at falador have lobsters in bank!",
discord = "BlackJesus#7321", name = "Guard Thiver", servers = { "Zenyte" }, version = "0.1")
